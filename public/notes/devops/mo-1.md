MODULE-1
Introduction to DevOps and Cloud Computing & S C M (08 hours)

- What is DevOps ( mo-1 -1 pdf)
  – Software Development life cycle models (Planning to Maintenance & Support) ( mo-1 -1 pdf)
  – History of DevOps ( mo-1 -1 pdf)
  – DevOps Roles and Goals ( mo-1 -1 pdf)
  – Difference between Agile and DevOps ( mo-1 -1 pdf)
  – How DevOps solves Development to operation risks. ( mo-1 -1 pdf)
  Introduction to DevOps Tools,bestpractices in DevOps.
...
Git and Jenkins.   ( mo-1 -2 pdf only git)
SLE: Cloud Native
